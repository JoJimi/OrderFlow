...
public class EventLogEventConsumer {
    ...
    public void consumeOrderEvent(
        ...
        try {
            ...
            // 이벤트 로그 저장
            eventLogService.saveEventLog(event, "order-service");
    ...
    public void consumePaymentEvent(
        ...
        try {
            ...
            // 이벤트 로그 저장
            eventLogService.saveEventLog(event, "payment-service");
    ...
    /**
     * 배송 이벤트 구독
     * - ShippingPrepared, ShippingStarted, ShippingCompleted
     */
    @KafkaListener(
    ...
    public void consumeShippingEvent(
        ...
        try {
            ...
            // 이벤트 로그 저장
            eventLogService.saveEventLog(event, "shipping-service");
    ...
    public void consumeInventoryEvent(
        ...
        try {
            ...
            // 이벤트 로그 저장
            eventLogService.saveEventLog(event, "inventory-service");
