...
public class SecurityConfig {
    ...
    /**
     * Event-Logging-Service 전용 JwtAuthenticationFilter
     * BaseSecurityConfig의 빈 생성을 우회하고 명시적으로 null 주입
     */
    @Bean
    public JwtAuthenticationFilter jwtAuthenticationFilter() {
        log.info("🔧 Event-Logging-Service: JwtAuthenticationFilter 생성 (UserDetailsService=null, TokenBlacklistChecker=null)");
